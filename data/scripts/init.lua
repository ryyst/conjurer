...
-- * We want to preserve everything else as much as possible for inter-mod compatibility
-- * ModLuaFileAppend and ModTextFileSetContent are run too late from our own init.
local IS_VANILLA_MAP = ModSettingGet("raksa.map_selection") == "noita"
